...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="{{ url("index.html") }}">Nas.Duk.Apps</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="{{ url("index.html") }}" class="logo me-auto"><img src="frontend/assets/img/logo.png" alt="" class="img-fluid"></a>-->
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{ url("#services") }}">Pelayanan</a></li>
          <li><a class="nav-link   scrollto" href="{{ url("#portfolio") }}">Produk</a></li>
          <li><a class="nav-link scrollto" href="{{ url("#team") }}">Hubungi</a></li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              <h4>Card 3</h4>
              <p>Card</p>
              <a href="{{ url("frontend/assets/img/portfolio/portfolio-8.jpg") }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="{{ url("portfolio-details.html") }}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              <h4>Web 3</h4>
              <p>Web</p>
              <a href="{{ url("frontend/assets/img/portfolio/portfolio-9.jpg") }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
              <a href="{{ url("portfolio-details.html") }}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ url("#") }}">Dashboard</a></li>
